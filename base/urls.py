...
urlpatterns = [
    ...
    path("creator/brand_proposal/accept_or_reject/<int:proposal_id>" , views.accept_or_reject , name='accept_or_reject' ),
    ...
    #path("creator/content_approval/<int:proposal_id>/<slug:slug>/" , views.content_approval_process   , name="content_approval_with_slug"),
